...
#define schedSCHEDULING_POLICY_EDFS 3		/* Earliest-deadline-first scheduling */

/* Configure scheduling policy by setting this define to the appropriate one. */
#define schedSCHEDULING_POLICY schedSCHEDULING_POLICY_EDFS //schedSCHEDULING_POLICY_EDFS / RMS
 ...
 * not included) */
#define schedMAX_NUMBER_OF_PERIODIC_TASKS 8
